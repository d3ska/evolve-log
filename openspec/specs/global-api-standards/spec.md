# Spec: Global API Standards

## Purpose

Defines the HTTP response conventions that apply to every controller in the system:
status codes for successful operations, and the standard error envelope for all error paths.
